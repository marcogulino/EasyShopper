...
public class SaveProductListener implements OnClickListener {
	...
	public SaveProductListener(EditText productName, EditText editPrice, String barcode, CurrencyRetriever currencyRetriever, ProductSaver productSaver, Activity activity) {
